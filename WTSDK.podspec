Pod::Spec.new do |spec|
    ...
    spec.subspec 'Category' do |core|
         core.source_files = 'WTSDK/Category/*.{h,m}', 
    end

    #可以看到通过subspec可以区分出不同的模块,而且模块间也能依赖
    spec.subspec 'Tool' do |core|
         core.source_files = 'WTSDK/Tool/*.{h,m}', 
    end

    #可以看到通过subspec可以区分出不同的模块,而且模块间也能依赖
    spec.subspec 'View' do |core|
         core.source_files = 'WTSDK/View/*.{h,m}', 
    end
